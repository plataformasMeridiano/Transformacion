"""
run_pases_abr.py — Descarga SOLO Pases para los días de la primera semana de abril 2026.
...
async def main() -> int:
    ...
    setup_logging(general["log_dir"], "pases_abr")
    logger = logging.getLogger("pases_abr")
    ...
    for alyc_cfg in alycs:
        ...
        alyc_override.setdefault("opciones", {})["tipo_operacion"] = ["Pases"]
