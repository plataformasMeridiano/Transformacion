"""
run_retry_abr.py — Reintento de DAValores, BACS, MaxCapital, Dhalmore
para los días de la primera semana de abril 2026 (ambos tipos).
"""
import asyncio
import json
import logging
...
ALYCS_TARGET = {"DAValores", "BACS", "MaxCapital", "Dhalmore"}
...
async def main() -> int:
    ...
    setup_logging(general["log_dir"], "retry_abr")
    logger = logging.getLogger("retry_abr")
    ...
    alycs = [a for a in config["alycs"] if a.get("activo") and a["nombre"] in ALYCS_TARGET]
